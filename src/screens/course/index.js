...
let pageTypes = {
    ...
    "grid-fullwidth": {
        ...
        extraClasses1: ["big-margin-left", "big-margin-right",],
    },
    "grid-large": {
        subpages: false,
        template: null,
    ...
    "tabs-fullscreen": {
        ...
        extraClasses1: ["fullscreen",],
        extraClasses2: ["flex-grow-0",],
        extraClasses3: ["big-margin-left", "big-margin-right",],
        extraClasses4: ["fullscreen",],
        pageClasses: ["flex-grow-1",],
    },
    "tabs-fullwidth": {
        subpages: true,
        template: require("./tabs.html"),
